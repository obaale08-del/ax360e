    ...
    public static class SettingsFragment extends PreferenceFragmentCompat implements
        ...
        public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
            ...
            final String[] BOOL_KEYS={
                ...
                "GPU|force_depth_clamp",
                "GPU|gamma_decode_pwl_resolve",
                "GPU|gamma_render_target_as_unorm16",
                "GPU|gpu_3d_to_2d_texture",
                ...
                "GPU|no_discard_stencil_in_transfer_pipelines",
                "GPU|non_seamless_cube_map",
                "GPU|readback_memexport",
                "GPU|readback_resolve_half_pixel_offset",
                "GPU|resolve_check_number_format",
                "GPU|resolve_resolution_scale_fill_half_pixel_offset",
                "GPU|snorm16_render_target_full_range",
                "GPU|store_shaders",
                "GPU|tiled_shared_memory",
                ...
                "Kernel|staging_mode",
                "Logging|flush_log",
                "Logging|log_high_frequency_kernel_calls",
                ...
                "Vulkan|vulkan_semaphore_reuse_workaround",
                "Vulkan|vulkan_sparse_shared_memory",
                "Vulkan|vulkan_validation",
                "a64|a64_enable_host_guest_stack_synchronization",
            };
            final String[] INT_KEYS={
                "GPU|texture_cache_memory_limit_hard",
                "GPU|texture_cache_memory_limit_soft",
                "General|priority_class",
                "General|recent_titles_entry_amount",
                "General|time_scalar",
                "Memory|mmap_address_high",
                "Memory|scribble_heap_value",
                "UI|font_size",
                "UI|window_size_x",
                "UI|window_size_y",
                "Video|custom_internal_display_resolution_x",
                "Video|custom_internal_display_resolution_y",
            };
